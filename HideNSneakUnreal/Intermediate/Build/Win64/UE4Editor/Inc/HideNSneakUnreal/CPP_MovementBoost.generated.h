...
class AActor;
struct FHitResult;
#ifdef HIDENSNEAKUNREAL_CPP_MovementBoost_generated_h
#error "CPP_MovementBoost.generated.h already included, missing '#pragma once' in CPP_MovementBoost.h"
#endif
...
public: \
	DECLARE_CLASS(ACPP_MovementBoost, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/HideNSneakUnreal"), NO_API) \
...
#define HideNSneakUnreal_Source_HideNSneakUnreal_CPP_MovementBoost_h_17_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ACPP_MovementBoost); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ACPP_MovementBoost); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ACPP_MovementBoost(ACPP_MovementBoost&&); \
	NO_API ACPP_MovementBoost(const ACPP_MovementBoost&); \
public:
...
template<> HIDENSNEAKUNREAL_API UClass* StaticClass<class ACPP_MovementBoost>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID HideNSneakUnreal_Source_HideNSneakUnreal_CPP_MovementBoost_h
